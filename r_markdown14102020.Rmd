...
## Use cbind function
```{r}
MPs1617 <- data.frame(MPs_names=c(claims1617$MP.s.Name))
expenses1617 <- data.frame(Expenses=c(claims1617$Expense.Type))
expenseamountclaimed1617 <- data.frame(Paid=c(claims1617$Amount.Claimed))
mps_1617_amountclaimed <- cbind(MPs1617,expenses1617, expenseamountclaimed1617)
```
